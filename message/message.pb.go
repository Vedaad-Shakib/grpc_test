...
func (*HelloRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_b4fb1c6bdff134cb, []int{0}
}
...
func (*HelloReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_message_b4fb1c6bdff134cb, []int{1}
}
...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/message.Greeter/SayHelloAgain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHelloAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/message.Greeter/SayHelloAgain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() { proto.RegisterFile("message.proto", fileDescriptor_message_b4fb1c6bdff134cb) }

var fileDescriptor_message_b4fb1c6bdff134cb = []byte{
	...
	0xa8, 0x89, 0x91, 0x8b, 0xdd, 0xbd, 0x28, 0x35, 0xb5, 0x24, 0xb5, 0x48, 0xc8, 0x82, 0x8b, 0x23,
	0x38, 0xb1, 0x12, 0xac, 0x4d, 0x48, 0x54, 0x0f, 0x66, 0x39, 0xb2, 0x55, 0x52, 0xc2, 0xe8, 0xc2,
	0x05, 0x39, 0x95, 0x4a, 0x0c, 0x42, 0xb6, 0x5c, 0xbc, 0x30, 0x9d, 0x8e, 0xe9, 0x89, 0x99, 0x79,
	0xa4, 0x69, 0x77, 0xd2, 0xe2, 0x92, 0xc8, 0xcc, 0xd7, 0x4b, 0x2f, 0x2a, 0x48, 0xd6, 0x4b, 0xad,
	0x48, 0xcc, 0x2d, 0xc8, 0x49, 0x2d, 0x86, 0x29, 0x74, 0xe2, 0xf1, 0x85, 0x30, 0x02, 0x40, 0x61,
	0x10, 0xc0, 0x98, 0xc4, 0x06, 0x0e, 0x0c, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd7, 0x10,
	0x1c, 0x22, 0x1d, 0x01, 0x00, 0x00,
}
