...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='message',
  syntax='proto3',
  serialized_pb=_b('\n\rmessage.proto\x12\x07message\"\x1c\n\x0cHelloRequest\x12\x0c\n\x04name\x18\x01 \x01(\t\"\x1d\n\nHelloReply\x12\x0f\n\x07message\x18\x01 \x01(\t2\x82\x01\n\x07Greeter\x12\x38\n\x08SayHello\x12\x15.message.HelloRequest\x1a\x13.message.HelloReply\"\x00\x12=\n\rSayHelloAgain\x12\x15.message.HelloRequest\x1a\x13.message.HelloReply\"\x00\x42*\n\x18io.grpc.examples.messageB\x0cMessageProtoP\x01\x62\x06proto3')
)
...
_GREETER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SayHelloAgain',
    full_name='message.Greeter.SayHelloAgain',
    index=1,
    containing_service=None,
    input_type=_HELLOREQUEST,
    output_type=_HELLOREPLY,
